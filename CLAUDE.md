...
| `docs/dominio-consultas.md` | Taxonomía de categorías de consulta y roadmap — define agentes/sub-agentes y división de responsabilidades. **Habilitado: Laboral → Despido + Rubros laborales + Trabajador rural + Call center · Familia → sus 5 subcategorías (violencia de género con tratamiento diferencial, ver §4) · Tránsito → sin subcategorías en v1 (corpus a nivel categoría)** |
