...
| `docs/dominio-consultas.md` | Taxonomía de categorías de consulta y roadmap — define agentes/sub-agentes y división de responsabilidades. **Habilitado: Laboral → Despido + Rubros laborales + Trabajador rural + Call center · Familia → sus 5 subcategorías (violencia de género con tratamiento diferencial, ver §4) · Arrendamiento y desalojo → sus 5 subcategorías (desalojo particionado por régimen: 8.153 / 14.219 / 19.889)** |
