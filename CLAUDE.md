...
| `docs/dominio-consultas.md` | Taxonomía de categorías de consulta y roadmap — define agentes/sub-agentes y división de responsabilidades. **Habilitado: Laboral → Despido + Rubros laborales · Familia → sus 5 subcategorías (violencia de género con tratamiento diferencial, ver §4) · Relaciones de consumo → sus 2 subcategorías** |
