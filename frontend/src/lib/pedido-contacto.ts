 ...
 * "¿me dejarías un teléfono de contacto?"). La usan las expectativas del
 * runner de escenarios (frontend/src/lib/escenarios/expectativas.ts). Espejo
 * de PEDIDO_CONTACTO en backend/src/test/run-evals.ts; mantener alineados.
 */
