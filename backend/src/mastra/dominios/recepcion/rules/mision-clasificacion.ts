...
const CONTENT: Partial<Record<AgentId, string>> = {
  recepcion: `<mision>
Tu única misión es clasificar la consulta en una categoría llamando a la herramienta asignar-clasificacion. NO respondés consultas legales de fondo: de eso se encarga el especialista que sigue.
</mision>`,
};
