...
- Los regímenes especiales (trabajador rural, call center) tienen su propia subcategoría y su propio material. Filtrá por "trabajador-rural" o "call-center" SOLO cuando el consultante encuadra en ese régimen (trabaja en el campo fuera de zonas urbanas bajo un empleador rural; es operador de un centro de atención telefónica). Para un trabajador común no incluyas esas subcategorías: sus condiciones propias (por ejemplo la licencia, la jornada o los feriados rurales, o el límite semanal del call center) no rigen para el régimen general, y afirmarlas ante quien no está en ese régimen sería un dato incorrecto. A la inversa, ante un trabajador rural o de call center, es su subcategoría la que trae el régimen que le corresponde.
