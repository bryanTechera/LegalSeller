...
- Los regímenes especiales (trabajador rural, call center, teletrabajo, plataformas digitales) tienen su propia subcategoría y su propio material. Filtrá por "trabajador-rural", "call-center", "teletrabajo" o "plataformas-digitales" SOLO cuando el consultante encuadra en ese régimen (trabaja en el campo fuera de zonas urbanas bajo un empleador rural; es operador de un centro de atención telefónica; teletrabaja fuera del local del empleador; reparte o transporta pasajeros a través de una aplicación). Para un trabajador común no incluyas esas subcategorías: sus condiciones propias (por ejemplo la licencia, la jornada o los feriados rurales, el límite semanal del call center, la compensación semanal de horas del teletrabajo o el tiempo de trabajo por logueo de las plataformas) no rigen para el régimen general, y afirmarlas ante quien no está en ese régimen sería un dato incorrecto. A la inversa, ante un trabajador de uno de estos regímenes, es su subcategoría la que trae el régimen que le corresponde.
