...
Estas preguntas surgieron al incorporar el documento al asistente. Ninguna bloquea lo ya incorporado: el asistente responde hoy con el contenido del documento y, en los puntos dudosos, es prudente y deriva al abogado. Les pedimos responder debajo de cada pregunta (en este mismo documento o por el canal habitual), indicando el número de la pregunta.

---

## 1. Nombre de la subcategoría de desalojo del régimen sin garantía

El diagrama de categorías que nos enviaron originalmente llamaba a una subcategoría "Desalojo ley 19980". El documento de arrendamientos trata en todo momento el régimen sin garantía de la **Ley Nº 19.889** (arts. 421 a 459) y no menciona ninguna ley 19.980.
...
En la página 22 del documento, la tabla comparativa de falta de pago dice, para el régimen general:

> "Clausura única — Texto consolidado del art. 51: deuda + 40%; revisar aplicación al régimen concreto."
...
El desalojo de la vivienda vinculada al empleo (DL 14.219, art. 35, plazo de 30 días) quedó en la subcategoría de desalojos del decreto-ley. Para el trabajador **rural** ya teníamos material propio (desalojo como precario, Decreto 216/012), que se mantiene en el área laboral.
...
*Cómo responder: debajo de cada pregunta, o por el canal habitual citando el número. Al recibir las respuestas, las incorporamos al asistente y este documento pasa a estado RESPONDIDA con fecha.*
