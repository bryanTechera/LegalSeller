# Preguntas al equipo legal — Documentos de rubros laborales (enviados 2026-07-19)

**Referencia**: los cuatro documentos que nos enviaron sobre rubros laborales:

1. *JORNADA DE TRABAJO + HORAS EXTRAS + DESCANSO SEMANAL TRABAJADO + DESCANSO
   INTERMEDIO + TIEMPO IN ITINERE* (6 páginas)
2. *DESCANSO SEMANAL + LICENCIA + SALARIO VACACIONAL + AGUINALDO* (14 páginas)
3. *SALARIO O REMUNERACIÓN -EN DINERO Y EN ESPECIE-* (8 páginas)
4. *TRABAJO NOCTURNO* (4 páginas)

Las páginas citadas corresponden a cada PDF.

**Cómo responder**: pueden contestar directamente debajo de cada pregunta y
...
## 1. ¿El Convenio Internacional del Trabajo n.º 171 está ratificado por Uruguay?

El documento *TRABAJO NOCTURNO* (página 2) dice: *"el **Convenio n.º 171 (no
ratificado)** plantea tres opciones en su artículo 7..."*.

Pero el documento *DESPIDO* que nos enviaron antes dice, en su capítulo de
trabajo nocturno: *"nuestro país **ratificó en el año 2017** (dos años después de
la aprobación de la ley) el Convenio Internacional del Trabajo n.º 171"*.

Cargamos ambos textos tal cual están, pero se contradicen.
...
- Página 2: *"el Convenio n.º 132 sobre vacaciones anuales pagadas, de 1970, el
  cual fue ratificado por Uruguay a través del **decreto-ley n.º 14.588 del 30 de
  agosto de 1970**"*.
- Página 4: *"Este Convenio ha sido ratificado por el **decreto-ley n.º 14.568 de
  30 de agosto de 1976**, y siendo su fecha posterior a las normas anteriormente
  citadas, es aplicable a nuestro régimen jurídico laboral"*.

Difieren el número de la norma y el año.
...
dinero abonadas por el patrono entre el 1.º de diciembre de un año y el **31 de
noviembre** del siguiente"* — fecha que no existe. La página 11 del mismo
documento define el período correctamente: *"entre el 1.º de diciembre de un año
y el **30 de noviembre** del año siguiente"*.

Así lo cargamos al sistema: **30 de noviembre**.
...
por el Decreto 535/014, establece una serie de requisitos..."*. Entendemos que se
refiere al **decreto** de 29 de octubre de 1957 (así lo llama el propio documento
en las demás menciones, p. ej. *"el art. 22 del decreto del 29 de octubre de
1957"*). Así lo cargamos.
...
extras realizadas entre el 1.º de enero y el 31 de diciembre... **En segundo
lugar, El tercer paso** consiste en realizar los promedios de horas extras
...
El documento enumera tres excepciones para no considerar horas extras lo que
supere las ocho horas: *"a) redistribución de la jornada; b) ciclo de tres
semanas y; **c) semana inglesa**"*. Las dos primeras se desarrollan; la semana
inglesa no vuelve a aparecer.
...
laborales (prescripción/caducidad). Para orientar consultas de sueldos, horas
extras o licencias impagas es un dato crítico: cuánto tiempo hacia atrás se puede
reclamar y hasta cuándo después del egreso. Mientras tanto, el asistente no
afirma ningún plazo.
...
Las dejamos como están en el documento; avisen si corrigen el original:

- *"**Pude** incluirse a todos los feriados"* (DESCANSO..., p. 6 — ¿"Puede"?)
- *"En el caso del trabajador jornalero **la cuenta el** 1,66 entre 25"*
  (DESCANSO..., p. 5 — parece faltar una palabra)
- *"el aguinaldo se **fracciones** en dos etapas"* (DESCANSO..., p. 12 —
  ¿"fraccione"?)
- *"solo el exceso de dicho tiempo **es tomados** en consideración"*
  (JORNADA..., p. 5)
- *"indemnizan de posibles perjuicios; **premias** el mejor desempeño"*
  (SALARIO..., p. 7 — ¿"premian"?)
- *"las gratificaciones que **sea regulares y permanente**"* (SALARIO..., p. 8 —
...
*Nota de edición: al cargar los textos removimos únicamente artefactos de la
digitalización (encabezados de página del material fuente intercalados en medio
de oraciones y marcadores de notas al pie). El contenido quedó textual.*
