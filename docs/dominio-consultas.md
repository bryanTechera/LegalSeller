...
| **Licencias especiales** | ✅ **habilitada 2026-07-31** (guía IMPO sobre Leyes 18.345 y 18.458: estudio, paternidad y adopción, matrimonio, duelo, hijos con discapacidad, familiares a cargo con discapacidad o enfermedad terminal). **Ampliada 2026-08-06** con controles de embarazo — propios y del acompañante (Ley 20.129, red. Ley 20.212). Subcategoría NO particionada (aplica a todo trabajador privado). Maternidad y licencia por enfermedad quedan fuera (pregunta legal 2026-07-31 pendiente) |
| **Seguro de desempleo** | ✅ **habilitada 2026-08-06** (anexo del equipo legal: Decreto-Ley 15.180 en la redacción de la Ley 18.399 + Decreto 162/009 — causales, requisitos y plazo de solicitud, monto y duración, exclusiones y cese, despido ficto). No estaba en la taxonomía original — encuadre como subcategoría propia con confirmación pedida en `docs/preguntas-legales/2026-08-06-anexo-laboral.md`. NO particionada como régimen (es una prestación del régimen general): `dimensionar-despido` ancla su relevamiento ante despido/suspensión |
| **Teletrabajo** | ✅ **habilitada 2026-08-06** (Ley 19.978 — acuerdo escrito, reversibilidad, jornada con límite semanal y compensación de horas, desconexión, herramientas, seguridad). Subcategoría **particionada** (su régimen de horas extras contradice el general). Falta el Decreto reglamentario 86/022 (pedido en la pregunta legal 2026-08-06) |
